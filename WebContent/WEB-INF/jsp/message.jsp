...
<html>
 ...
 <body >
	...
	<div id="restPage">
		...
		<button id="add_button" class="btn btn-success" onclick="addMessage()" disabled="disabled">Add</button><br>
		<button id="see_table_id" class="btn btn-success" >See All Messages</button><br>
